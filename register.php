            ...
            <form action="" method="post">
                <div class="container">
                    <div class="content">
                        ...
                        <div class="first">
                            <input type="text" placeholder="User Name" name="username" id="user_name" Required>
                        </div>
                        <div class="second">
                            <input type="email" placeholder="Example@gmail.com" name="email" id="password" Required>
                        </div>
                        <div class="second">
                        ...
                        <div class="sec">
                            <a href="http://localhost/mywork/oauth/oauth.php"> <img
